...
from social_embodied.tasks.ambiguous_reference import build_task_0_spec, build_task_1_1_spec
...
def get_task_spec(task_id: str) -> TaskSpec:
    ...
    if task_id in {"task_1_1", "reference_no_history_s1_0000"}:
        return build_task_1_1_spec()
